...
import thumbnailHD from './Quick Snacks/Pink Oyster 65/pinkoyster65HD.jpg'

export const PINK_OYSTER_65_IMAGES = {
  thumbnail: thumbnailHD,
  nutrition: nutritionImage,
  ingredients: ingredientsImage,
  process: makingProcessImage,
  howWeMakeIt: servingImage,
} as const
